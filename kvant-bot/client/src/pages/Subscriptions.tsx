...
import { useGetSubscriptions, useMarkSubscriptionPaid, useGetUsers, useCreateSubscription } from "@/lib/hooks";
                ...
                sortedSubs.map((sub: any) => (
                  <TableRow key={sub.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <TableCell className="text-center">
                      <Badge
                        variant="secondary"
                        className={`text-base px-3 py-1 ${sub.remainingLessons === 0 ? 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300' : 'bg-primary/10 text-primary'}`}
                      >
